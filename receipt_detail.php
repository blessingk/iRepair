                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <div id="edit-profile" class="tab-pane">
                            <section class="panel">
                                <h1><a class="pull-right btn btn-primary" href="receipts.php"><i class="icon_refresh"></i> Back</a> <input type="button" class="btn btn-primary" value="Print" onclick="printDiv('printableArea')" /></h1>
                                <div id="printableArea" class="panel-body bio-graph-info">
                                    <div>
                                        ...
                                        <div class="row">
                                        <h4 align="center"><strong><u>CASH RECEIPT</u></strong></h4>
