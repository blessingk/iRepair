    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa-user-md"></i>Purchase Section</h3>
                        <ol class="breadcrumb">
                            ...
                            <div id="edit-profile" class="tab-pane">
                                <section class="panel">
                                    <div class="panel-body bio-graph-info">
                                        <h1> Update Item <a class="pull-right btn btn-primary" href="purchases.php"><i class="icon_refresh"></i> Back</a></h1>
                                        <form class="form-horizontal" method="post" role="form">
                                            <?php
                                            $ids=$_GET['stock_number'];
                                            $query="SELECT * FROM stocks WHERE stock_number='$ids'";
                                            //var_dump($query3);die();
                                            $res = $pdo->query($query);
                                            while($row = $res->fetch()) {
                                            ...
                                            ?>
                                                ...
                                                if(isset($_POST['record'])){
                                                    ...
                                                    try {
                                                        ...
                                                        $update = "UPDATE `stocks` SET sup_name='".$name."', description='".$desc."', quantity='".$quant."', price='".$price."', sale_price='".$sprice."', total_p='".$total."', total_s='".$total_s."' where stock_number='$stock'";
                                                $pdo->exec($update);
