            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-mobile-phone"></i>Receipt reports</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            <table class="table table-striped table-advance table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    $qry="SELECT * FROM receipts WHERE receipt_date >= (CURDATE() - INTERVAL 1 DAY) ORDER BY receipt_id DESC ";
                                                    //var_dump($query3);die();
                                                    $res = $pdo->query($qry);
                                                    if($res->rowCount() > 0){
                                                    while($row = $res->fetch()){
                                        ...
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            <table class="table table-striped table-advance table-hover">
                                                ...
                                                <tr>
                                                    <?php
                                                    //$id=$_GET['record_number'];
                                                    $qry="SELECT * FROM receipts WHERE receipt_date >= (CURDATE() - INTERVAL 7 DAY) ORDER BY receipt_id DESC ";
                                                    //var_dump($query3);die();
                                                    $res = $pdo->query($qry);
                                                    if($res->rowCount() > 0){
                                                    while($row = $res->fetch()){
                                        ...
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            <table class="table table-striped table-advance table-hover">
                                                ...
                                                <tr>
                                                    <?php
                                                    //$id=$_GET['record_number'];
                                                    $qry="SELECT * FROM receipts WHERE receipt_date >= (CURDATE() - INTERVAL 30 DAY) ORDER BY receipt_id DESC ";
                                                    //var_dump($query3);die();
                                                    $res = $pdo->query($qry);
                                                    if($res->rowCount() > 0){
                                                    while($row = $res->fetch()){
                                        ...
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            <table class="table table-striped table-advance table-hover">
                                                ...
                                                <tr>
                                                    <?php
                                                    //$id=$_GET['record_number'];
                                                    $qry="SELECT * FROM receipts WHERE receipt_date >= (CURDATE() - INTERVAL 120 DAY) ORDER BY receipt_id DESC ";
                                                    //var_dump($query3);die();
                                                    $res = $pdo->query($qry);
                                                    if($res->rowCount() > 0){
                                                    while($row = $res->fetch()){
                                        ...
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            <table class="table table-striped table-advance table-hover">
                                                ...
                                                <tr>
                                                    <?php
                                                    //$id=$_GET['record_number'];
                                                    $qry="SELECT * FROM receipts WHERE receipt_date >= (CURDATE() - INTERVAL 180 DAY) ORDER BY receipt_id DESC ";
                                                    //var_dump($query3);die();
                                                    $res = $pdo->query($qry);
                                                    if($res->rowCount() > 0){
                                                    while($row = $res->fetch()){
                                        ...
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            <table class="table table-striped table-advance table-hover">
                                                ...
                                                <tr>
                                                    <?php
                                                    //$id=$_GET['record_number'];
                                                    $qry="SELECT * FROM receipts WHERE receipt_date >= (CURDATE() - INTERVAL 356 DAY) ORDER BY receipt_id DESC ";
                                                    //var_dump($query3);die();
                                                    $res = $pdo->query($qry);
                                                    if($res->rowCount() > 0){
                                                    while($row = $res->fetch()){
