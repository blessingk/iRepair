            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-mobile-phone"></i>Inventory</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <section class="panel">
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            if(isset($_POST['record'])){
                                                ...
                                                try {
                                                    $ins = "INSERT INTO `inventory` (`sup_name`, `description`, `quantity`, `price`, `sale_price`, `total_p`, `inventory_number`, `inventory_date`, `status`, `total_s`) VALUES ('$name', '$desc', '$quant', '$price', '$sprice', '$total', '$id', CURRENT_DATE, 'inventory', '$total_s' )";
                                                    $pdo->exec($ins);
                                        ...
                                        <div class="panel-body bio-graph-info">
                                            ...
                                            <table class="table table-striped table-advance table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    $qry="SELECT * FROM inventory ORDER BY inventory_id DESC ";
                                                    //var_dump($query3);die();
                                                    $res = $pdo->query($qry);
                                                    if($res->rowCount() > 0){
                                                    while($row = $res->fetch()){
                                                    ...
                                                    <td><div class="btn-group">
                                                            <a class="" href="sale_inventory.php?inventory_number=<?php echo $stock; ?>" onclick='return confirm("Are you sure you want to sale this item?")' title='Sale Item' data-toggle='tooltip'><span class='glyphicon glyphicon-plus'></span></a>
                                                            | <a class="" href="edit_inventory.php?inventory_number=<?php echo $stock; ?>" onclick='return confirm("Are you sure you want to edit item?")' title='Edit Item' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span> </a>
                                                            | <a class="" href="delete_inventory.php?inventory_number=<?php echo $stock; ?>" onclick='return confirm("Are you sure you want to delete item?")' title='Delete Item' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span> </a>
